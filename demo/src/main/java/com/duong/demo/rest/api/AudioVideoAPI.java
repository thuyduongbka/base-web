...
public class AudioVideoAPI {
    ...
    public static final String TEXT_PATH = "/static/texts";
    ...
    public Mono<ResponseEntity<byte[]>> streamTxt(@RequestHeader(value = "Range", required = false) String httpRangeList,
                                                    @PathVariable("fileName") String fileName) {
        return Mono.just(getContent(TEXT_PATH, fileName, httpRangeList, "text"));
    }
